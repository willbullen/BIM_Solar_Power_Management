          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div>
                    ...
                    <Card className="bg-muted/50 mb-6">
                      <CardHeader className="pb-2">
                        <CardTitle className="text-base">
                          Bot Configuration
                          <Badge 
                            variant={telegramSettings?.isEnabled ? "default" : "outline"}
                            className="ml-2"
                          >
                        ...
                        <CardDescription>
                          Configure the Telegram bot settings (Admin only)
                        </CardDescription>
                      </CardHeader>
                      <CardContent>
                        {isLoadingTelegram ? (
                            ...
                            <form className="space-y-4">
                              ...
                              <FormField
                                ...
                                render={({ field }) => (
                                  <FormItem>
                                    ...
                                    <FormDescription>
                                      The username of your bot (e.g. EmporiumBot)
                                    </FormDescription>
                                    <FormMessage />
                                  </FormItem>
                                )}
                              ...
                              <FormField
                                ...
                                render={({ field }) => (
                                  <FormItem className="flex flex-row items-center justify-between p-4 border rounded-lg">
                                    <div className="space-y-0.5">
                                      <FormLabel className="text-base">Enable Telegram Bot</FormLabel>
                                      <FormDescription>
                                        Enable or disable the Telegram integration
                                      </FormDescription>
                                    </div>
                                    <FormControl>
                                      <Switch
                              ...
                              <div className="flex justify-end space-x-2 pt-2">
                                ...
                                <Button 
                                  type="button"
                                  onClick={() => {
                                    const data = telegramBotForm.getValues();
                ...
                {/* Telegram User Connection Status */}
                    ...
                    {isLoadingTelegramStatus ? (
                      ...
                      <div className="space-y-4">
                        <div className="flex flex-col space-y-1">
                          ...
                          <span className="text-sm">@{telegramStatus.telegramUsername}</span>
                        </div>
                        ...
                        <div className="flex flex-col space-y-1">
                          ...
                          <span className="text-sm">{
                            telegramStatus.lastAccessed 
                              ? new Date(telegramStatus.lastAccessed).toLocaleString() 
                              : "Never"
                          }</span>
                        </div>
                          ...
                          <form className="space-y-4">
                              ...
                              render={({ field }) => (
                                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                                  <div className="space-y-0.5">
                                    ...
                                    <FormDescription className="text-xs">
                                      Receive critical alerts and warnings
                                    </FormDescription>
                                  </div>
                                  <FormControl>
                                    <Switch
                              ...
                              render={({ field }) => (
                                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-3">
                                  <div className="space-y-0.5">
                                    ...
                                    <FormDescription className="text-xs">
                                      Receive daily and weekly summary reports
                                    </FormDescription>
                                  </div>
                                  <FormControl>
                                    <Switch
                            ...
                            <div className="flex justify-end space-x-2 pt-2">
                              ...
                              <Button 
                                ...
                                size="sm"
                                onClick={() => {
                                  const data = telegramPrefsForm.getValues();
                                  onUpdateTelegramPreferences(data);
                                }}
                                disabled={updateTelegramPrefsMutation.isPending}
                              >
                      ...
                      <div className="space-y-4">
                        <Alert>
                          ...
                          <AlertDescription>
                            Connect your Telegram account to receive notifications directly on your phone.
                          </AlertDescription>
                        </Alert>
                        ...
                        {telegramStatus?.verificationCode ? (
                          <div className="space-y-4">
                            <div className="bg-muted p-4 rounded-md text-center">
                              <p className="text-sm mb-2">Send this code to our bot to connect your account:</p>
                              <p className="text-xl font-bold tracking-wide">{telegramStatus.verificationCode}</p>
                              <p className="text-xs text-muted-foreground mt-2">
                                Code expires in {
                                  telegramStatus.verificationExpires 
                                    ? new Date(telegramStatus.verificationExpires).toLocaleTimeString() 
                                    : "10 minutes"
                                }
                              </p>
                            </div>
                            ...
                            <div className="text-sm">
                              <p className="mb-2">Steps to connect:</p>
                              <ol className="list-decimal list-inside space-y-1">
                                <li>Open Telegram and search for @{telegramSettings?.botUsername || "EmporiumBot"}</li>
                                <li>Start a conversation with the bot</li>
                                <li>Send the verification code above</li>
                              </ol>
                            </div>
                          </div>
                        ) : (
